...
forecast_days = 5  # Fixed to 5 days
...
for name, model in models.items():
    ...
    # Store metrics
    results.append({"Model": name, "MSE": mse, "MAE": mae, "R² Score": r2})
    ...
    fig.update_layout(title=f"{name} Forecast", xaxis_title="Date", yaxis_title="Price")
...
st.dataframe(metrics_df.style.format({"MSE": "{:.2f}", "MAE": "{:.2f}", "R² Score": "{:.2f}"}))
